      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="border rounded-lg p-4 bg-gray-50">
            <h3 className="font-semibold mb-2">{product.title + " "} <br />{product.ti} Highlights</h3>
          ...
          <div className="space-y-4">
            <div className="border-b">
              ...
              {openAccordion === 'details' && (
                <div className="pb-4">
                  {product.ti} are made with ZQ Merino wool, providing temperature regulation, moisture-wicking, and odor-reducing properties. The shoe features a comfortable foam insole and a durable rubber outsole.
                </div>
              )}
            </div>
            <div className="border-b">
              ...
              {openAccordion === 'sustainability' && (
                <div className="pb-4">
                  {product.ti} are made with sustainable and renewable materials. The upper is crafted from ZQ Merino wool, and the laces are made from recycled plastic bottles. The sole is made from SweetFoam™, a sugarcane-based green EVA.
                </div>
              )}
            </div>
            <div className="border-b">
