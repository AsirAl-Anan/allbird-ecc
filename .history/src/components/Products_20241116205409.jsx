    ...
    >
      ...
      <div className="mt-4 space-y-2">
        <NavLink
          ...
          className="w-full text-center cursor-pointer block bg-black text-white py-2 px-4 text-sm font-bold uppercase rounded transition-colors duration-300 ease-in-out hover:bg-gray-200 hover:text-black hover:border-zinc-500"
        >
