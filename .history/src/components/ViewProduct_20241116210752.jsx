    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="border rounded-lg p-4 bg-gray-50">
            <h3 className="font-semibold mb-2 lg:text-2xl md:text-xl sm:text-lg">{product.title + " "}</h3>
          ...
          <NavLink onClick={()=>addTocart(product)} className="block  text-center w-full bg-gray-800 text-white py-3 px-4  hover:bg-gray-400 transition duration-300">
...
<div 
    ...
    >
      ...
      <div className="mt-4 space-y-2">
        ...
        <NavLink onClick={()=> console.log(product.id)} to={`/products/product/${product.id}`}           className="w-full  text-center cursor-pointer block bg-white text-black border border-black py-2 px-4 text-sm font-bold uppercase rounded transition-colors duration-300 ease-in-out hover:bg-gray-900 hover:text-white hover:border-red-400"
