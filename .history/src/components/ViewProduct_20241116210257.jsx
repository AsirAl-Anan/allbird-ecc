    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="border rounded-lg p-4 bg-gray-50">
          ...
          <NavLink onClick={()=>addTocart(product)} className="block text-center w-full bg-gray-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 transition duration-300">
            Add to Cart
          </NavLink>
