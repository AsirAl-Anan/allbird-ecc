...
function ifLoggedIn(){
  ...
  <div className="relative">
    ...
    />
    <span className="absolute -top-3 -right-2 text-sm bg-red-500 rounded-lg text-center w-[15px]">
      {cartLength}
    </span>
  </div>
</div>
        ...
        <div className="lg:hidden flex items-center justify-between px-4 py-3 border-b shadow-sm">
          ...
          <NavLink to={'/'} className="block text-xl font-bold font-pacifico">AllBird</NavLink >
          <div className="flex items-center space-x-4">
            <div className="relative">
              <button
                onClick={() => setIsProfileDropdownOpen(!isProfileDropdownOpen)}
