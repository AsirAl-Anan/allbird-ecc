    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Left Column */}
          <div>
            <h1 className="text-2xl font-semibold mb-4"> <NavLink className={'inline-block bg-slate-400 rounded-md text-lg p-2 font-sa'}  to={-1}> <ArrowBigLeftDash className='inline-block' /> Go back  </NavLink> Checkout   </h1>
