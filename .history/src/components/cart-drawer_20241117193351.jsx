...
export default function CartDrawer({ isOpen, onClose,  }) {
 ...
 const {cart, increaseItem, decreaseItem, removeItem ,cartTotal ,checkout} = useContext(AddCartContext)
      ...
      <div className={`fixed top-0 right-0 h-full w-full md:w-[400px] bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white border-t">
          <div className="p-4">
            ...
            <button onClick={()=>alert('Check out Function is not implemented')}
