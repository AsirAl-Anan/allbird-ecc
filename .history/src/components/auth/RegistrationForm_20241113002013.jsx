...
export default function RegistrationForm() {
  ...
  const { createUserWithEmail, user, setUser, createUserWithGoogle ,createUserWithGitHub, auth } = useContext(AuthContext);
  ...
  const handleSubmit = async () => {
    ...
    // Use ref values directly instead of updating state first
