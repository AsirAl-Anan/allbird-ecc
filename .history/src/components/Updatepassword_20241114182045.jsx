    ...
    <>
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
          ...
          <p
            className="text-center text-sm text-indigo-500 mt-6 cursor-pointer"
            onClick={() => {
              setDisplay(!display);
            }}
          >
          ...
          <label className="block mb-2 text-sm font-medium text-gray-700">Enter account Email</label>
          ...
          display && (
            ...
            <NavLink
              ref={passUpdateRef}
              className={
                'btn  text-center w-full py-2 my-2 mt-4 bg-teal-500 text-white rounded hover:bg-gray-800 block'
              }
              onClick={passwordUpdateEmail}
            >
          ...
          <NavLink
            className="btn block text-center w-full py-2 my-2 mt-4 bg-teal-500 text-white rounded hover:bg-gray-800"
