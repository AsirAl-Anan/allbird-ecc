    ...
    <div>
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#F1EBE7] p-4 sm:p-0">
        ...
        <div>
          ...
          />
        <NavLink onClick={handleEditProfile} > <span className='flex flex-row-reverse'>{
          editProfile ?  <PenOff > "Close edit"  </PenOff> : <SquarePen /><h1 className='mx-1'>Edit</h1> </span>}</NavLink>
