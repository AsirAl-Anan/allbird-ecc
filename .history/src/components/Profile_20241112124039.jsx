    ...
    <div>
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#F1EBE7] p-4 sm:p-0">
        ...
        <div>
          ...
          <input
            type="email"
            className="mb-4 w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-300"
            placeholder="Email"
          ...
          />
        <NavLink onClick={handleEditProfile} > <span className='flex flex-row-reverse'><SquarePen /><h1 className='mx-1'>Edit</h1> </span></NavLink>
