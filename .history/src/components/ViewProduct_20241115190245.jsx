...
export default function ProductPage() {
  ...
  const renderStarRating2 = (rating) => {
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
     ...
     <Recomendation product={product} renderStarRating={renderStarRating2} />
    </div>
    <Footer />
    </>
...
const Recomendation = ({product , renderStarRating}) =>{
 ...
 console.log(recommendedproduct)
  ...
  recommendedproduct.map((item)=>{  <RecommendedItems key={product.id} product={item} renderStarRating={renderStarRating}/>})
...
const RecommendedItems =({product,renderStarRating}) =>
{
  return(
<>
