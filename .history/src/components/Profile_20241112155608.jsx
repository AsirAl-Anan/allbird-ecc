...
const Profile = () => {
  ...
  const { user, reauthWithGoogle,userCredential,authCredential ,updateEmail, currentPassword,
    setCurrentPassword} = useContext(AuthContext);
  console.log(userCredential,authCredential,updateEmail)
  const auth = getAuth();
