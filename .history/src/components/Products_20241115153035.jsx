  ...
  return (
    ...
    >
      ...
      <div className="mt-4 space-y-2">
        ...
        <NavLink onClick={()=> console.log(product.id)}  className="w-full block bg-white text-black border border-black py-2 px-4 text-sm font-bold uppercase rounded transition-colors duration-300 ease-in-out hover:bg-gray-100">
          View Product
        </NavLink>
      </div>
    </div>
