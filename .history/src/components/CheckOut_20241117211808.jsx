...
import { ChevronDown, Search, Visa, Mastercard, Amex, Paypal } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <button className="bg-[#5469d4] text-white py-3 rounded hover:bg-[#4054b2] transition-colors duration-200">
                Shop Pay
              </button>
              <button className="bg-[#ffc439] py-3 rounded h-[48px] flex items-center justify-center">
            ...
            <div className="border rounded mb-4">
              <label className="flex items-center p-4 flex-wrap">
                <input
                  type="radio"
                  name="paymentMethod"
                  value="credit-card"
                ...
                <div className="ml-auto flex space-x-2 items-center mt-2 sm:mt-0">
                  <Visa className="h-6 w-auto" />
                  <Mastercard className="h-6 w-auto" />
                  <Amex className="h-6 w-auto" />
                </div>
              </label>
            ...
            <div className="border rounded mb-4">
              <label className="flex items-center p-4 justify-between">
            ...
            <div className="border rounded mb-4">
              <label className="flex items-center p-4 justify-between">
                ...
                <img src="/afterpay.png" alt="Afterpay" className="h-6 w-auto" />
              </label>
            </div>
            ...
            <button className="w-full bg-black text-white py-3 rounded mb-4 hover:bg-gray-800 transition-colors duration-200">
              Pay now
            </button>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <div className="flex items-center mb-4">
                <div className="relative w-16 h-16 mr-4">
                  <img src="/placeholder.svg" alt="Product" className="w-full h-full object-cover rounded" />
                ...
                <div className="flex-grow">
                  <h3 className="text-sm font-medium">Men's Wool Runners - Savanna Night (Navy Sole)</h3>
                  <p className="text-sm text-gray-500">8</p>
                </div>
                <p className="font-medium">$98.00</p>
              </div>
              <div className="flex mb-4">
                ...
                />
                <button className="bg-gray-200 text-gray-800 px-4 rounded-r hover:bg-gray-300 transition-colors duration-200">Apply</button>
              </div>
              <div className="border-t pt-4">
                ...
                <div className="flex justify-between font-medium">
                  <span>Total</span>
                  <span><span className="text-gray-500 text-sm">USD</span> $98.00</span>
                </div>
              </div>
            </div>
          </div>
