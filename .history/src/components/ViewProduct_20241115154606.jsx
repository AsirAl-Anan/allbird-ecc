      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="border rounded-lg p-4 bg-gray-50">
            <h3 className="font-semibold mb-2">{product.title + " "} <br />{product.title} Highlights</h3>
          ...
          <div className="space-y-4">
            <div className="border-b">
              ...
              {openAccordion === 'details' && (
                <div className="pb-4">
                  {product.title} are made with ZQ Merino wool, providing temperature regulation, moisture-wicking, and odor-reducing properties. The shoe features a comfortable foam insole and a durable rubber outsole.
                </div>
              )}
            </div>
            <div className="border-b">
