...
import  Avater from '../../../images/defaultAvater'
const Navbar = () => {
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white z-50">
        ...
        <div className="hidden lg:flex items-center justify-between px-6 py-4 border-b shadow-sm">
          ...
          <div className="flex items-center space-x-8">
            ...
            src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp" className="rounded-full w-10"/>
            
            </div>
              <HelpCircle className="w-5 h-5 cursor-pointer hover:opacity-70" />
