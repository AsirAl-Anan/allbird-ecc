...
import { getAuth, createUserWithEmailAndPassword, onAuthStateChanged, GoogleAuthProvider, sendEmailVerification, signInWithPopup, signOut, GithubAuthProvider, updateEmail, reauthenticateWithCredential, EmailAuthProvider } from "firebase/auth";
