          ...
          <div className="space-y-4">
            <div className="border-b">
              ...
              {openAccordion === 'details' && (
                <div className="pb-4">
                  {product.description} re made with ZQ Merino wool, providing temperature regulation, moisture-wicking, and odor-reducing properties. The shoe features a comfortable foam insole and a durable rubber outsole.
                </div>
              )}
            </div>
            <div className="border-b">
