...
function ProductCard({ product, rating, addTocart }) {
  ...
  return (
    <div
      className="flex flex-col w-[300px] bg-white p-3 rounded-lg transition-shadow duration-300 ease-in-out hover:shadow-[box-shadow: rgba(17, 17, 26, 0.1) 0px 8px 24px, rgba(17, 17, 26, 0.1) 0px 16px 56px, rgba(17, 17, 26, 0.1) 0px 24px 80px;"
    ...
    >
      ...
      <div className="mt-4 space-y-2">
        <NavLink
          ...
          className="w-full cursor-pointer block bg-black text-white py-2 px-4 text-sm font-bold uppercase rounded transition-colors duration-300 ease-in-out hover:bg-gray-800"
        >
          Add to Cart
        </NavLink>
        <NavLink
          to={`product/${product.id}`}
          className="w-full cursor-pointer block bg-white text-black border border-black py-2 px-4 text-sm font-bold uppercase rounded transition-colors duration-300 ease-in-out hover:bg-gray-100"
        >
          View Product
        </NavLink>
      </div>
