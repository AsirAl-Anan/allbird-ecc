    ...
    >
      ...
      <div className="mt-4 space-y-2">
        ...
        <NavLink
          ...
          className="w-full  cursor-pointer block bg-white text-black border border-black py-2 px-4 text-sm font-bold uppercase rounded transition-colors duration-300 ease-in-out hover:bg-gray-900 hover:text-white hover:border-red-400"
        >
          View Product
        </NavLink>
      </div>
