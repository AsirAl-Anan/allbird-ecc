  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Recomendation product={product} addTocart={addTocart}/>
      </div>
      <Footer />
    </>
  );
}
const Recomendation = ({ product ,addTocart }) => {
      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {recommendedproduct.map((item) => (
            <RecommendedItems key={item.id} product={item} addTocart={addTocart} />
          ))}
        </div>
      </div>
    </>
...
const RecommendedItems = ({ product, addTocart }) => {
    ...
    <>
      ...
      >
        ...
        <div className="mt-4 space-y-2">
          <NavLink   onClick={()=> addTocart(product)}        className="w-full text-center cursor-pointer block bg-black border text-white py-2 px-4 text-sm font-bold uppercase rounded transition-colors duration-300 ease-in-out hover:bg-gray-400 hover:text-black hover:border-zinc-500"
          >
