  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#F1EBE7] p-4 sm:p-0">
        <form className="w-full max-w-lg p-6 sm:p-8 bg-white bg-opacity-60 backdrop-blur-md shadow-lg rounded-lg">
...
<div className="relative mb-4">
  ...
  <div className="flex items-center">
    <input
      ...
      ref={passwordRef}
    />
    <NavLink className="ml-2 flex items-center cursor-pointer">
      <Eye />
    </NavLink>
  </div>
</div>
