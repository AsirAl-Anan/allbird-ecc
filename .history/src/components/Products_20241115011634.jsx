...
const Products = () => {
  ...
  return (
    <div>
      <Navbar />
      Products page
      <div className='grid grid-cols-3 max-w-[1500px] mx'>
      {
        allProducts.map((product)=>{return <div  key={product.id} className='w-[300px] m-10 '><ProductCard key={product.id} product={product}  /> </div> })
       }
