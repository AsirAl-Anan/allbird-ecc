...
function ProductCard({ product, rating, addTocart }) {
  ...
  return (
    <div
      className="flex flex-col w-[300px] bg-white p-3 rounded-lg transition-shadow duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-6 transition"
    ...
    >
      ...
      <div className="mt-4 space-y-2">
        <NavLink
          ...
          className="w-full text-center cursor-pointer block bg-black border text-white py-2 px-4 text-sm font-bold uppercase rounded transition-colors duration-300 ease-in-out hover:bg-gray-200 hover:text-black hover:border-zinc-500"
        >
