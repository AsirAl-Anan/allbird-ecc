    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="border rounded-lg p-4 bg-gray-50">
            <h3 className="font-semibold mb-2 lg:text-2xl md:text-xl sm:text-lg">{product.title + " "} <br /> Highlights</h3>
          ...
          <NavLink onClick={()=>addTocart(product)} className="block border-amber-200 text-center w-full bg-gray-800 text-white py-3 px-4  hover:bg-gray-400 transition duration-300">
