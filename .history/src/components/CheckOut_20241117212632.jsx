        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <button className="bg-[#ffc439]  rounded flex items-center justify-center">
                <Paypal className="w-12 h-3" /> {/* Reduced PayPal button size */}
              </button>
            </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border rounded">
                      <label className="flex items-center p-4">
                        ...
                        <div className="ml-auto flex items-center space-x-2">
                          <Visa className="w-8 h-5" /> {/* Adjusted credit card icon sizes */}
                          <Mastercard className="w-8 h-5" />
                          <Amex className="w-8 h-5" />
                        </div>
                      </label>
                    ...
                    <div className="border rounded">
                      <label className="flex items-center p-4">
                        ...
                        <Paypal className="w-12 h-3 ml-auto" /> {/* Reduced PayPal icon size */}
                      </label>
                    </div>
                  </div>
