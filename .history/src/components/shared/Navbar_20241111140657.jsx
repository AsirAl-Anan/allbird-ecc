          ...
          <Sheet>
            ...
            <SheetContent side="left" className="w-[300px] p-0">
              ...
              <nav className="flex flex-col">
                <Link className="flex items-center justify-between border-b p-4 text-sm font-medium hover:underline">
                  MEN
                ...
                <Link className="flex items-center justify-between border-b p-4 text-sm font-medium underline">
                  SUSTAINABILITY
                  <ChevronRight className="h-4 w-4" />
                </Link>
                <Link className="flex items-center justify-between border-b p-4 text-sm font-medium">
