...
const Profile = () => {
  ...
  const { user, emailUpdate, sendEmailVerification ,reauthenticateWithCredential, credential} = useContext(AuthContext);
  ...
  const handleSubmit = async ()  => {
    try{
      const result = await reauthenticateWithCredential(credential);
