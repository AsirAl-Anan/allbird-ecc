  ...
  const handleSubmit = async () => {
    ...
    try {
      if (user.providerData[0].providerId === 'google.com') {
        ...
        // Send verification email to the new address first
        await sendEmailVerification({
          email: email, // Pass the new email
          currentUser: user
        });
        
        setVerificationSent(true);
        alert('Please check your email for verification. Once verified, your email will be updated.');
