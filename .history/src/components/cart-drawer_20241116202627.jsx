...
export default function CartDrawer({ isOpen, onClose,  }) {
 ...
 const {cart, increaseItem, decreaseItem, removeItem} = useContext(AddCartContext)
        ...
        <div className="overflow-y-auto h-[calc(100vh-240px)] p-4">
         {
            ...
            cart.map((item) => {
                return (
                    <>
                     <SingleCartItem cartItem={item} increaseItem={increaseItem} decreaseItem={decreaseItem} removeItem={/>
                    </>
                )
            } )
         } 
