      ...
      <div className="flex justify-center items-center min-h-screen bg-[#F1EBE7] p-4 sm:p-0">
        <form className="w-full max-w-md p-6 sm:p-8 bg-white bg-opacity-60 backdrop-blur-md shadow-lg rounded-lg">
          ...
          <div className="relative mb-4">
            ...
            <input
              type="password"
              className="w-full px-3 py-2 pr-10 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-200"
              placeholder="Password"
              ref={passwordRef}
            />
            <NavLink className="absolute inset-y-0 right-3 flex items-center cursor-pointer">
              <Eye />
            </NavLink>
          </div>
