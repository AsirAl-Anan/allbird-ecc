    ...
    <>
      ...
      >
        ...
        <div className="mt-4 space-y-2">
          <NavLink   onClick={()=> add}        className="w-full text-center cursor-pointer block bg-black border text-white py-2 px-4 text-sm font-bold uppercase rounded transition-colors duration-300 ease-in-out hover:bg-gray-400 hover:text-black hover:border-zinc-500"
          >
