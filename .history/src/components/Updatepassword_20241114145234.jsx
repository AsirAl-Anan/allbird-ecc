...
return (
    <>
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
        ...
        <NavLink ref={passUpdateRef} className={"btn block text-center w-full py-2 my-2 mt-4 bg-teal-500 text-white rounded hover:bg-gray-800 hidden"} onClick={passwordUpdateEmail}>
