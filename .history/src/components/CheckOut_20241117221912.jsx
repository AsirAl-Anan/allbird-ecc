...
const CheckoutPage = () => {
  ...
  const [name, setName] = useState(user ? user?.displayName : 'no name');
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Left Column */}
          <div>
            <h1 className="text-2xl font-semibold mb-4"> <NavLink className={'inline-block bg-slate-400 rounded-md text-lg p-2 font-sans hover:bg-slate-500'}  to={-1}> <ArrowBigLeftDash className='inline-block' /> Go back  </NavLink> Checkout   </h1>
            
            <div className="grid grid-cols-2 gap-4 mb-4">
              <button className="bg-[#5469d4] text-white py-3 rounded">
                Shop Pay
              </button>
              <div className="bg-[#ffc439] py-3 rounded h-[48px] flex items-center justify-center">
            ...
            <button onClick={()=>{alert('Order Placed successfully')}} className="w-full bg-black text-white py-3 rounded mb-4">
              Pay now
            </button>
