            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between items-center mt-2">
                  <div className="flex items-center">
                    <span className="mr-2 ">Qty: <Plus className='inline mx-1 cursor-pointer' onClick={()=> increaseItem(cartItem)} /> {cartItem.quantity} <Minus className='cursor-pointer inline mx-1' /></span>
