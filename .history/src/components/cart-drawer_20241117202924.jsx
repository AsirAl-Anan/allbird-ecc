...
export default function CartDrawer({ isOpen, onClose,  }) {
 ...
 const {cart, increaseItem, decreaseItem, removeItem ,cartTotal ,checkout ,checkOutCheck, checkOutProduct, setCheckOutProduct,setCheckOutCheck} = useContext(AddCartContext)
