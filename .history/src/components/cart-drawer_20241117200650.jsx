...
export default function CartDrawer({ isOpen, onClose,  }) {
 ...
 const {cart, increaseItem, decreaseItem, removeItem ,cartTotal ,checkout ,checkOutCheck} = useContext(AddCartContext)
      ...
      <div className={`fixed top-0 right-0 h-full w-full md:w-[400px] bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white border-t">
          <div className="p-4">
            ...
            <button onClick={()=>checkout().then(()=> checkOutCheck ? navigate('/checkout'): toast.error('Please add items to cart'))} className="w-full p-2 bg-blue-600
