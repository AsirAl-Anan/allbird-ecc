            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <div className="flex justify-between">
                  <div>
                    <h3 className="font-medium sm:text-lg md:text-lg ">{cartItem.title}</h3>
                    <p className="text-sm text-gray-600">{cartItem.description.length > 20 ? cartItem.description.slice(0,25) : cartItem.description}</p>
