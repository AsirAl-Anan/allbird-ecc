...
const Subscribe = () => {
  ...
  return (
    <div>
      ...
      <div className="max-w-3xl mx-auto text-center py-8 px-4 sm:py-12 sm:px-6">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-4">Wear-All-Day Comfort</h3>
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-4">Sustainability In Every Step</h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-4">Materials From The Earth</h3>
            <p className="text-gray-700">
