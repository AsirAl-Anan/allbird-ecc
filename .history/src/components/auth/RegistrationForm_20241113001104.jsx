...
export default function RegistrationForm() {
  ...
  const handleSubmit = async () => {
    ...
    setPassword(passwordRef.current.value);
      ...
      await createUserWithEmail(email, password).then(()=>{console.log('Account Created'); navigate('/');});;
  ...
  const handleGoogleLogin = async () => {
      ...
      await createUserWithGoogle().then(()=>{console.log('Account Created'); navigate('/');});
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#F1EBE7] p-4 sm:p-0">
        <form className="w-full max-w-md p-6 sm:p-8 bg-white bg-opacity-60 backdrop-blur-md shadow-lg rounded-lg" onSubmitbutton={handleSubmit}>
