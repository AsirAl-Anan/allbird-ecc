        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <form className="space-y-4">
              <div>
                <label htmlFor="email" className="block text-sm font-medium mb-1">Account</label>
                <input
                  id="email"
                  type="email"
                  value={email}
              ...
              <div>
                ...
                <input id="company" type="text" className="w-full border rounded p-2" />
              </div>
              <div>
          ...
          {/* Right Column */}
          <div className="bg-white p-6 rounded-lg shadow mt-8 lg:mt-0">
