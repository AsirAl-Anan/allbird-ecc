...
export default function CartDrawer({ isOpen, onClose,  }) {
 ...
 const {cart, increaseItem, decreaseItem} = useContext(AddCartContext)
        ...
        <div className="overflow-y-auto h-[calc(100vh-240px)] p-4">
         {
            ...
            cart.map((item) => {
                return (
                    <>
                     <SingleCartItem cartItem={item} increaseItem={increaseItem} decreaseItem={decreaseItem}/>
                    </>
                )
            } )
         } 
...
const SingleCartItem = ({cartItem, increaseItem, decreaseItem}) => {
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between items-center mt-2">
                  <div className="flex items-center">
                    <span className="mr-2 ">Qty: <Plus className='inline mx-1 cursor-pointer' onClick={()=> increaseItem(cartItem)} /> {cartItem.quantity} <Minus onClick={()=> decreaseItem} className='cursor-pointer inline mx-1' /></span>
