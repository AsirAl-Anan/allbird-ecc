...
<div className="relative mb-4">
  ...
  <div className="flex items-center">
    <input
      ...
      ref={passwordRef}
    />
    <div className="absolute top-2 right-3 transform -translate-y-1/2 flex items-center cursor-pointer">
...
<div className="relative mb-4">
  ...
  <div className="flex items-center">
    ...
    />
    <div className="absolute top-1/2 right-3 transform -translate-y-1/2 flex items-center cursor-pointer">
      <Eye className="h-5 w-5" />
    </div>
  </div>
</div>
