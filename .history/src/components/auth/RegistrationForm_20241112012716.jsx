...
export default function RegistrationForm() {
  ...
  const handleSubmit = () => {
    ...
    createUserWithEmail(email, password).then(()=> {navigate('/'), toast.success('Account Created')}).catch((err)=>{toast.error(err.message)})
    
  };
   const handleGoogleLogin = () =>{
    return createUserWithGoogle().then(res=>{setUser(res.user), toast.success('Account Created')}).catch((error) => {
      // Handle Errors here.
