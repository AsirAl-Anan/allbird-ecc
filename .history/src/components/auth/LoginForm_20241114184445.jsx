...
export default function LoginForm() {
 ...
 const {createUserWithGoogle , ifNotLoggedIn, auth,  createUserWithGitHub} = useContext(AuthContext)
  ...
  return (
    ...
    <div className="flex justify-center items-center h-screen bg-[#F1EBE7] ">
      <form className="w-full max-w-md p-8 bg-white shadow-md rounded" >
        ...
        <NavLink onClick={handleSingnIn}  className="w-full block my-2 text-center py-2 bg-black text-white rounded hover:bg-gray-800">Sign In</NavLink>
        <NavLink onClick={handleGoogleLogin} className="btn block text-center w-full py-2 mt-2 bg-black text-white rounded hover:bg-gray-800">Sign In with Google <FontAwesomeIcon icon={faGoogle} className='mx-2'/></NavLink>
        <NavLink
