...
export default function ProductPage() {
  ...
  const Recomendation = () =>{
    ...
    useEffect(()=>{
      ...
      if(product && product.category){
        fetch(`https://fakestoreapi.com/products/category/${product.category}`).then(res => res.json()).then(data =>setrecommendedProduct(data))
  ...
  },[product?.category]) //going on infinite loop
